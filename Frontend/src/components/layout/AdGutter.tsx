...
export function AdGutter({ position }: AdGutterProps) {
  return (
    <aside className="hidden xl:flex flex-col items-center justify-start py-8 px-3 border border-dashed border-border/80 rounded-2xl bg-card/30 backdrop-blur-sm min-h-[650px] text-center select-none sticky top-8 h-[calc(100vh-8rem)]">
